...
import android.pages.AddTicketPageAndroid;
...
public class TestCasesAndroid {
  ...
  public static String executionOS = ANDROID;
  public static String statementEmail = "consulting-Android@consultingteam.tester.com";
  public static String statementPws = "Consulting1234!";
  public static String statementEmailNOCash = "consulting-nocash-Android@consultingteam.tester.com";
  public static String statementPwsNOCash = "Consulting1234!";
  public static String statementEmailSpaces = "  consulting-Android@consultingteam.tester.com";
  ...
  public static String statementEditEmail = "consulting-Android_pass@consultingteam.tester.com";
   ...
   * "executionOS" FLAG
   */
  public AppiumDriver getDriver(String testName) throws InterruptedException {
    AppiumDriver driver = null;
    try {
      driver = Utils.getBrowserStackAndroidDriver(testName);
    } catch (Exception e) {
  ...
  public void TC001_Starting_Find_Proximate_Juckeboxes() throws InterruptedException {
    ...
    try {
      ...
      StatementPageAndroid statementPage = new StatementPageAndroid(driver);
  ...
  public void TC005_Starting_Find_Proximate_Juckeboxes_Find_Current_Location() throws InterruptedException {
    ...
    try {
       ...
       */
      LoginPageAndroid loginPage = new LoginPageAndroid(driver);
      ProximateAndroidPage proximatePage = new ProximateAndroidPage(driver);
  ...
  /*
   * SignUp_Create a Free Statement with email
   */
  @Test()
  ...
  public void TC018_Home_Find_Proximate_Jukeboxes_Add_Spot_to_favorites_with_login() throws InterruptedException {
    ...
    try {
       ...
       */
      LoginPageAndroid loginPage = new LoginPageAndroid(driver);
      SpotPageAndroid spotPage = new SpotPageAndroid(driver);
      StatementPageAndroid statementPage = new StatementPageAndroid(driver);
      ProximateAndroidPage proximatePage = new ProximateAndroidPage(driver);
  ...
  /*
   * Validate that button for Password reveal will display password used
   */
  @Test()
  ...
  public void TC043_My_Statement_Manage_Statement_User_Profile_Save_Button() throws InterruptedException {
    ...
    try {
      ...
      loginPage.loginAgain("newmailAndroid@mail.com", statementPws);
  ...
  public void TC052_My_Statement_Manage_Statement_Password_Password_length() throws InterruptedException {
    ...
    try {
      ...
      statementPage.logout();
      loginPage.loginAgain(statementEditEmail, newPasswordMore20);
      statementPage.restorePassword(newPasswordMore20, statementEditEmail);
      statementPage.logout();
      /*
       * End test
       */
  ...
  public void TC085_Home_Find_Proximate_Jukeboxes_Search_a_Spot_using_location() throws InterruptedException {
    String testName = "TC085 - Home_Find Proximate Jukeboxes_Remove a Spot from favorites";
    AppiumDriver driver = getDriver(testName);
  ...
  /*
   * Validate user can access Refer a friend by using the share link
   */
  @Test()
  ...
  /*
   * Validate the system allows deleting a track from the tracklist
   */
  @Test()
  ...
  public void TC123_MyStatement_Settings_menu_Confirm_Purchase_Label_Option_Displayed() throws InterruptedException {
    String testName = "TC123 - MyStatement_Settings menu_Dark Mode Label Option Displayed";
    AppiumDriver driver = getDriver(testName);
  ...
  public void TC125_MyStatement_Settings_menu_Available_Cash_Tokens_Label_Option_Displayed() throws InterruptedException {
    String testName = "TC125 - MyStatement_Settings_menu_Available Cash Tokens Label Option Displayed";
    AppiumDriver driver = getDriver(testName);
  ...
  /*
   * Validate Refer A Friend Referrer label option is displayed in My Statement menu.
   */
  @Test()
  ...
  public void TC131_MyStatement_Settings_menu_Confirm_Purchase_Switch_ON_OFF() throws InterruptedException {
    String testName = "TC131 - MyStatement_Settings menu_Confirm Purchase Switch ON/OFF";
    AppiumDriver driver = getDriver(testName);
  ...
  public void TC151_All_Music_Guest_Verify_Guest_is_NOT_able_to_listen_track_from_search_results_Artist_home_page_Tracks_main_list() throws InterruptedException {
    ...
    try {
      ...
      loginPage.setQAEnv();
      proximatePage.selectTestLocation("Consulting");
      spotPage.playTrackAsGuest("Enter Sandman");
    ...
    */
    ...
    public void TC157_All_Music_Guest_Verify_Guest_is_NOT_able_to_listen_track_from_Artist_Hot_Here_section_Album_tracks_list() throws InterruptedException {
      ...
      try {
        ...
        loginPage.setQAEnv();
        proximatePage.selectTestLocation("Consulting");
        spotPage.playTrackAsGuestHotArtistsAlbum_Track();
  ...
  public void TC163_Home_Find_Proximate_Jukeboxes_Search_a_Spot_using_special_characters_in_All_Spots_field() throws InterruptedException {
    ...
    */
    ...
    public void TC164_All_Music_Search_non_existing_artist_special_characters() throws InterruptedException {
     ...
     /*
    * Create tracklist with special characters
    */
    @Test()
    ...
    */
    ...
    public void TC188_MyMusic_My_Tracklist_Verify_user_is_able_to_create_tracklist_using_special_characters() throws InterruptedException {
      String testName = "TC188_MyMusic_My Tracklists_Verify user is able to create Tracklist using special characters";
      AppiumDriver driver = getDriver(testName);
      ...
      try {
        ...
        /*
    * Error message should display when creating a tracklist with long name
    */
    @Test()
    ...
    */
    ...
    public void TC190_AddCash_Verify_user_is_not_able_to_exceed_50_in_balance() throws InterruptedException {
      ...
      try {
        ...
        LoginPageAndroid loginPage = new LoginPageAndroid(driver);
        StatementPageAndroid statementPage = new StatementPageAndroid(driver);
        AddTicketPageAndroid addTicketPage = new AddTicketPageAndroid(driver);
        SpotPageAndroid spotPage = new SpotPageAndroid(driver);
        ProximateAndroidPage proximatePage = new ProximateAndroidPage(driver);
    ...
    */
    ...
    /*
    * Verify error message when trying to use less than 16 numbers to register ticket
    */
    @Test()
